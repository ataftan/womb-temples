//img collage
const images = [
 "https://cdn.glitch.global/e573fc2d-d65d-49bb-9162-63429baf793c/motherhood.png?v=1747543178197",
   "https://cdn.glitch.global/e573fc2d-d65d-49bb-9162-63429baf793c/motherhood.png?v=1747543178197",
...
img.style.transform = `rotate(${randomAngle}deg)`;
  ...
  img.onload = () => {
    ...
    const randomWidth = Math.random() * 400 + 200;
...
let currentBg = $("body").css("background-image"); 
  ...
  $("#prompt-3").click(function () {
   ...
   $("#prompt-4").click(function () {
    ...
    $("body").css({
  "background-image": "url('https://cdn.glitch.global/e573fc2d-d65d-49bb-9162-63429baf793c/worship%20bg.png?v=1747597219647')",
